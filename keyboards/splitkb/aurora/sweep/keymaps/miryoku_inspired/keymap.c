...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT
    (
        KC_NO, KC_NO, KC_NO, C(KC_R), C(KC_T),                           KC_GRV, KC_7, KC_8, KC_9, KC_MINS,

        KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NO,                       KC_SCLN, KC_4, KC_5, KC_6, KC_EQL,

        C(KC_Z), C(KC_X), C(KC_C), C(KC_V), C(KC_Y),                     KC_0, KC_1, KC_2, KC_3, KC_BSLS,
    ...
    [_NAV] = LAYOUT
    (
        KC_NO, KC_NO, KC_NO, C(KC_R), C(KC_T),                           KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

        KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NO,                       KC_LCAP, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,
    ...
    (
        ...
        KC_NO, KC_LCBR, KC_RCBR, KC_NO, KC_NO,                           KC_NO, KC_RCTL, KC_RSFT, KC_LALT, KC_RGUI,

        KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, KC_NO,                       KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    ...
    (
        ...
        KC_F11, KC_F4, KC_F5, KC_F6, KC_SCRL,                            KC_NO, KC_RCTL, KC_RSFT, KC_LALT, KC_RGUI,

        KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS,                            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

                                    KC_TAB, KC_SPC,                  KC_TRNS, KC_NO
    ),
};
